  ...
  return (
    <ThemeProvider theme={MenuTheme}>
      <Paper className="code-preview">
        ...
        >
          <Typography variant="caption" gutterBottom> {codeType} Code Preview </Typography>
          ...
          >
            ...
            <>
                ...
                <Typography variant="caption" gutterBottom> Copied! </Typography>
            </>
              ) : (
                  <>
                <ContentCopyIcon sx={{ fontSize: 10 }}/>
                <Typography variant="caption" gutterBottom> Copy code </Typography>
              </>
                )}
            </Link>
          </Tooltip>
