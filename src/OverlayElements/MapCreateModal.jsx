    ...
    <ThemeProvider theme={MenuTheme}>
      ...
      <Paper
        ...
        <Typography variant="body2" component="p" color="warning">
          Creating a new map will erase the current map. Be sure to save your current map before creating a new one.
        </Typography>
        <TextField
          variant="outlined"
          id="width"
        ...
        <Button variant="contained" color="primary" onClick={() => {
            if (widthRef.current.value && heightRef.current.value) {
              ...
              if (isNaN(widthRef.current.value) || isNaN(heightRef.current.value)) {
